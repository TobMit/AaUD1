...
namespace tests
{
    ...
    private:
        ...
        Milliseconds cyklusInsert(int size, const int POC_OPAKOVANI, structures::Table<int, int> &pTable);
        Milliseconds durationInsert(int key, int cislo, structures::Table<int, int> &pTable);

        Milliseconds cyklusRemove(int size, const int POC_OPAKOVANI, structures::Table<int, int> &pTable);
        Milliseconds durationRemove(int key, structures::Table<int, int> &pTable);

        Milliseconds cyklusTryFind(int size, const int POC_OPAKOVANI, structures::Table<int, int> &pTable);
        Milliseconds durationPeek(int key, int cislo, structures::Table<int, int> &pTable);
