...
namespace tests
{
                                     ...
                                     structures::PriorityQueue<int> &pQueue)
    {
        ...
        Milliseconds durationPush = std::chrono::microseconds(0);
        Milliseconds durationPop = std::chrono::microseconds(0);
        Milliseconds durationPeek = std::chrono::microseconds(0);
    ...
    //------------------------------------------------------------------------
    Milliseconds PriorityQueueUloha3::cyklusPush(int size, const int POC_OPAKOVANI)
    {
    ...
    Milliseconds PriorityQueueUloha3::durationPush(int priority, int cislo, structures::PriorityQueue<int> &pQueue)
    {
        SimpleTest::startStopwatch();
        pQueue.push(priority, cislo);
        SimpleTest::stopStopwatch();
    ...
    //------------------------------------------------------------------------
    Milliseconds PriorityQueueUloha3::cyklusPop(int size, const int POC_OPAKOVANI, bool extraMeranie)
    {
        structures::PriorityQueue<int>* pQueue = this->makePriorityQueue();
        Milliseconds duration = std::chrono::microseconds(0); // nastaví premennú na nulu
        Milliseconds durationExtra = std::chrono::microseconds(0);
    ...
    Milliseconds PriorityQueueUloha3::durationPop(structures::PriorityQueue<int> &pQueue)
    {
        SimpleTest::startStopwatch();
        pQueue.pop();
        SimpleTest::stopStopwatch();
    ...
    //------------------------------------------------------------------------
    Milliseconds PriorityQueueUloha3::cyklusPeek(int size, const int POC_OPAKOVANI)
    {
        structures::PriorityQueue<int>* pQueue = this->makePriorityQueue();
        Milliseconds duration = std::chrono::microseconds(0); // nastaví premennú na nulu
        repairQueue(size, size, *pQueue);
    ...
    Milliseconds PriorityQueueUloha3::durationPeek(structures::PriorityQueue<int> &pQueue)
    {
        SimpleTest::startStopwatch();
        pQueue.peek();
        SimpleTest::stopStopwatch();
