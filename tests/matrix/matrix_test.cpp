...
namespace tests
{
    ...
    void MatrixUloha2::cyklus(char oznacenie, int podielRow, int podielColumn, int podielAt, structures::Matrix<int>& matica)
    {
        ...
        Microseconds durationRow = std::chrono::microseconds(0);
        Microseconds durationColumn = std::chrono::microseconds(0);
    ...
    //------------------------------------------------------------------------
    Microseconds MatrixUloha3::cyklusAt(int x, int y, const int POC_OPAKOVANI)
    {
    ...
    Microseconds MatrixUloha3::durationAt(int x, int y, structures::Matrix<int>& matica)
    {
        SimpleTest::startStopwatch();
        matica.at(x, y) = 7;
        SimpleTest::stopStopwatch();
    ...
    //---------------------------------------------------------------------
    Microseconds MatrixUloha3::cyklusAssign(int x, int y, const int POC_OPAKOVANI)
    {
        structures::Matrix<int>* matica = this->makeMatrix( x, y);
    ...
    Microseconds MatrixUloha3::durationAssign(structures::Matrix<int>& matica, structures::Matrix<int>& maticaAssign)
    {
        SimpleTest::startStopwatch();
